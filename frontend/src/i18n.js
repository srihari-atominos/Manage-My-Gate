  ...
  en: {
    translation: {
      ...
      issueReport: {
        ...
        loadingReports: 'Loading issue reports...',
        noReportsTitle: 'No issue reports found.',
        noReportsSubtitle: 'Try changing your search term or filters.',
        colNumber: 'Report #',
        colType: 'Type',
        colFeature: 'Feature',
        colTitle: 'Title',
        ...
        inspectTooltip: 'Inspect Report',
        viewBtn: 'View',
        detailModalTitle: 'Issue Report Details',
        loadingDetails: 'Loading report details...',
        copyReportNumber: 'Copy Report #',
        description: 'Description',
        reporterAndOrg: 'Reporter & Community',
        reporterName: 'Name',
        reporterEmail: 'Email',
        reporterRole: 'Role',
        techContext: 'Technical / Device Context',
        platform: 'Platform',
        ...
        enlarge: 'Enlarge',
        imageLoadError: 'Screenshot preview unavailable.',
        openDirectly: 'Open in new tab',
        noAttachment: 'No screenshot was attached to this report.',
        ...
        savingEmail: 'Saving...',
        emailSaveSuccess: 'Notification email configuration saved successfully!',
    ...
    translation: {
      ...
      dashboard: {
        ...
        cards: {
          ...
          issueReports: 'تقارير المشكلات',
        },
      },
      issueReport: {
        pageTitle: 'تقارير المشكلات',
        pageSubtitle: 'معاينة تقارير الأخطاء وطلبات الميزات والاستفسارات المقدمة من المجتمعات.',
        errorTitle: 'خطأ في تحميل التقارير',
        searchPlaceholder: 'البحث بالعنوان، رقم التقرير، المستخدم أو المنظمة...',
        allOrgs: 'جميع المجتمعات',
        startDate: 'تاريخ البدء',
        endDate: 'تاريخ الانتهاء',
        resetFilters: 'إعادة ضبط الفلاتر',
        loadingReports: 'جاري تحميل تقارير المشكلات...',
        noReportsTitle: 'لم يتم العثور على تقارير مشكلات.',
        noReportsSubtitle: 'جرب تغيير مصطلح البحث أو الفلاتر.',
        colNumber: 'رقم التقرير',
        colType: 'النوع',
        colFeature: 'الميزة',
        colTitle: 'العنوان',
        colReporter: 'مقدم التقرير',
        colOrg: 'المنظمة',
        colCreated: 'تاريخ الإرسال',
        inspectTooltip: 'معاينة التقرير',
        viewBtn: 'عرض',
        detailModalTitle: 'تفاصيل تقرير المشكلة',
        loadingDetails: 'جاري تحميل تفاصيل التقرير...',
        copyReportNumber: 'نسخ رقم التقرير',
        description: 'الوصف',
        reporterAndOrg: 'مقدم التقرير والمجتمع',
        reporterName: 'الاسم',
        reporterEmail: 'البريد الإلكتروني',
        reporterRole: 'الدور',
        techContext: 'سياق الجهاز والنظام التقني',
        platform: 'المنصة',
        appVersion: 'إصدار التطبيق',
        deviceModel: 'طراز الجهاز',
        osVersion: 'إصدار نظام التشغيل',
        attachment: 'لقطة الشاشة المرفقة',
        clickToEnlarge: 'انقر للتكبير',
        enlarge: 'تكبير',
        imageLoadError: 'معاينة لقطة الشاشة غير متاحة.',
        openDirectly: 'فتح في علامة تبويب جديدة',
        noAttachment: 'لم يتم إرفاق لقطة شاشة بهذا التقرير.',
        ...
        emailSaveSuccess: 'تم حفظ إعدادات البريد الإلكتروني للإشعارات بنجاح!',
        invalidEmailError: 'يرجى إدخال عنوان بريد إلكتروني صالحة.',
      },
    },
  },
}
