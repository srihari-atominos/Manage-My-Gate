  ...
  return (
    <div className="card kpi-card card-hover">
      <div className="kpi-title">
        <i className={iconClass} style={{ color: iconColor || 'var(--primary)', marginRight: '6px' }}></i> 
        {title}
      </div>
      <div className="kpi-value">{value}</div>
      <div className={`kpi-trend ${trendClass}`} style={trendType === 'neutral' ? { color: 'var(--text-muted)', background: 'var(--surface-bg)' } : {}}>
