...
import { CModal, CModalHeader, CModalTitle, CModalBody, CModalFooter, CButton, CFormSelect, CFormTextarea, CAlert } from '@coreui/react';
      ...
      <CModalBody>
        <div className="mb-4 bg-light p-3 rounded border">
          ...
          <div className="d-flex justify-content-between mb-1">
            ...
            <span className="fw-medium">{booking.startTime} - {booking.endTime}</span>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="p-3 rounded border" style={{ backgroundColor: refundCalculation.percentage === 0 ? '#fff3cd' : '#d1e7dd', borderColor: refundCalculation.percentage === 0 ? '#ffecb5' : '#badbcc' }}>
              <div className="d-flex justify-content-between mb-1">
                ...
                <span className="fw-bold" style={{ color: refundCalculation.percentage === 0 ? '#664d03' : '#0f5132' }}>{refundCalculation.percentage}%</span>
              </div>
              <div className="d-flex justify-content-between">
                <span style={{ color: refundCalculation.percentage === 0 ? '#664d03' : '#0f5132' }}>Estimated Refund:</span>
                <span className="fw-bold" style={{ color: refundCalculation.percentage === 0 ? '#664d03' : '#0f5132' }}>₹{refundCalculation.amount.toFixed(2)}</span>
              </div>
            ...
            <div className="text-muted small mt-1 text-center">
              <i className="fa-solid fa-info-circle me-1"></i> Final refund amount will be calculated by the system.
            </div>
          </div>
        ) : (
        ...
        <div className="mb-3">
          <label className="form-label fw-medium">Reason for Cancellation <span className="text-danger">*</span></label>
          <CFormSelect 
            value={reason} 
