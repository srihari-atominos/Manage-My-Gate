    ...
    <CCard className="border-0 shadow-sm mb-4">
      <CCardBody className="p-4">
        ...
        <div className="mb-4">
          ...
          />
          {errorMsg && !draft.bookingDate && <div className="invalid-feedback d-block">{errorMsg}</div>}
        </div>
        
        <div className="d-flex justify-content-end">
          <CButton color="primary" onClick={onNext} className="px-5 rounded-pill shadow-sm" disabled={!draft.bookingDate}>
