                    ...
                    >
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        {isSelected ? (
                          ...
                          <div className={`d-inline-flex align-items-center rounded-pill py-1 px-3 ${pillBg} ${pillText} fw-bold small`}>
                            <span className={`rounded-circle me-2 ${dotColor}`} style={{ width: '8px', height: '8px' }}></span>
                            {statusLabel}
                          </div>
                        )}
                      </div>
