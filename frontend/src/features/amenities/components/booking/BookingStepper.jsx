...
const BookingStepper = memo(({ currentStep }) => {
  ...
  return (
    <div className="d-flex justify-content-between align-items-center mb-4 position-relative" aria-label="Booking Progress">
      <div className="position-absolute w-100" style={{ height: '2px', backgroundColor: '#e2e8f0', zIndex: 0, top: '50%', transform: 'translateY(-50%)' }}></div>
      <div className="position-absolute" style={{ height: '2px', backgroundColor: '#321fdb', zIndex: 0, top: '50%', transform: 'translateY(-50%)', width: `${(currentIndex / (steps.length - 1)) * 100}%`, transition: 'width 0.3s ease' }}></div>
