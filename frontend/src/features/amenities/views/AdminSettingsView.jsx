...
const AdminSettingsView = () => {
  ...
  if (loading) {
    return (
      <div
        className="amenities-module-wrapper amenity-os-theme d-flex justify-content-center align-items-center"
          ...
          >
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', margin: 0 }} className="fw-medium">
                Configure global rules, payments, and workflows for your community.
              </p>
            </div>
          ...
          >
            <div className="card card-hover">
              ...
              <div className="form-group">
                <label className="form-label" style={{ textTransform: 'uppercase' }}>
            ...
            <div className="card card-hover" style={{ borderTop: '4px solid var(--info)' }}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange('bookingRules', 'advanceBookingDays', Number(e.target.value))
                  }
                  min="1"
                />
              </div>
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange('bookingRules', 'cancellationWindowHours', Number(e.target.value))
                  }
                  min="0"
                />
              </div>
