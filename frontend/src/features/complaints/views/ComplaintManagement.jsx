        ...
        <div className="view active" id="management">
          ...
          >
            ...
            >
              <i
                ...
                style={{ color: 'var(--ink-faint)', marginRight: '8px' }}
              ></i>
              <input
                type="text"
              ...
              <table className="ent-table">
                ...
                <tbody>
                  ...
                  {filteredComplaints.map((c) => {
                    ...
                    else if (['In Progress', 'Assigned'].includes(c.status))
                    ...
                    return (
                      <tr key={c._id}>
                        ...
                        <td>
                          <b style={{ color: 'var(--ink)' }} className="fw-semibold">
                            {c.title}
                          </b>
                          <br />
                        ...
                        <td>{c.category}</td>
                        <td>
                          <span className={priorityBadgeClass}>{c.priority}</span>
                        </td>
                        <td>
            ...
            {pagination && pagination.totalPages > 1 && (
              ...
              >
                <div style={{ color: 'var(--ink-soft)' }} className="small">
                  ...
                  {Math.min(pagination.currentPage * filterParams.limit, pagination.totalRecords)}{' '}
                  of {pagination.totalRecords} entries
                </div>
                <ul
                  className="pagination pagination-sm mb-0"
                  style={{ display: 'flex', listStyle: 'none', gap: '4px', margin: 0, padding: 0 }}
                >
                  ...
                  {Array.from({ length: Math.min(pagination.totalPages, 7) }, (_, i) => {
                    ...
                    return (
                      <li
                        key={p}
                        className={`page-item ${pagination.currentPage === p ? 'active' : ''}`}
                      >
                        <button
                          className="page-link"
                          ...
                          style={{
                            ...
                            border: '1px solid var(--border)',
                            background:
                              pagination.currentPage === p ? 'var(--primary)' : 'var(--bg)',
                            color: pagination.currentPage === p ? 'white' : 'var(--ink)',
                            borderRadius: '4px',
                            cursor: 'pointer',
                          }}
                        >
          ...
          {showRatingsModal && (
            <div className="complaint-modal-overlay" onClick={() => setShowRatingsModal(false)}>
              <div
                className="complaint-modal-content"
              ...
              >
                ...
                <div style={{ maxHeight: '60vh', overflowY: 'auto', padding: '16px' }}>
                  {ratedComplaints.length === 0 ? (
                    <div
                      style={{ textAlign: 'center', color: 'var(--ink-faint)', padding: '24px' }}
                    >
