...
const ComplaintSettings = () => {
  ...
  const toggleSuggestedIssue = (catIdx, issueIdx) => {
    setSettings((prev) => {
      const cats = [...(prev.categories || [])]
      cats[catIdx].suggestedIssues[issueIdx].isActive =
        !cats[catIdx].suggestedIssues[issueIdx].isActive
      return { ...prev, categories: cats }
    })
  }
  ...
  if (loading || !settings) {
    return (
      <div
        className="complaints-module-wrapper complaints-os-theme d-flex justify-content-center align-items-center"
      ...
      <div className="view-container">
        <div className="view active" id="settings">
          ...
          <div className="grid grid-2">
            ...
            <div className="card">
              <h3 style={{ marginBottom: '20px', color: 'var(--ink)' }} className="fs-6">
                Departments
              </h3>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '20px' }}>
                {(settings.departments || []).map((dep, idx) => (
                  <span key={idx} className="tag-chip">
                    {dep.name}{' '}
                    <i
                      className="small fa-solid fa-xmark"
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '20px' }}>
                {(settings.categories || []).map((cat, idx) => (
                  <span
                    key={idx}
                    className={`tag-chip ${activeCategoryIdx === idx ? 'selected' : ''}`}
                    style={
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              style={{
                                color: issue.isActive ? 'var(--ink)' : 'var(--ink-faint)',
                                textDecoration: issue.isActive ? 'none' : 'line-through',
                              }}
                              className="small"
                            >
                              {issue.name}
                            ...
                            {issue.usageCount > 0 ? (
                              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <span
                                  ...
                                  className="small"
                                >
                                  Used {issue.usageCount} times
                                </span>
                                {issue.lastUsedDate && (
                                  <span style={{ color: 'var(--ink-faint)' }} className="small">
                                    Last used: {new Date(issue.lastUsedDate).toLocaleDateString()}
                                  </span>
                                )}
                              </div>
                            ) : (
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            {issue.usageCount === 0 && (
                              <div style={{ display: 'flex', gap: '4px' }}>
                                {issue.isActive && (
                                  <button
                                    className="small btn btn-sm btn-outline-warning"
                                    style={{ padding: '2px 8px' }}
                                    onClick={() =>
                                      toggleSuggestedIssue(activeCategoryIdx, issueIdx)
                                    }
                                  >
                                    Disable
                                  </button>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    if (
                                      window.confirm(
                                        'Archive this suggestion? It will no longer appear in the UI.',
                                      )
                                    )
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                              <i
                                ...
                                style={{
                                  cursor: 'pointer',
                                  color: issueIdx === 0 ? 'var(--border)' : 'var(--ink-soft)',
                                }}
                                onClick={() =>
                                  moveSuggestedIssue(activeCategoryIdx, issueIdx, 'up')
                                }
                              ></i>
                              <i
                                ...
                                style={{
                                  cursor: 'pointer',
                                  color:
                                    issueIdx === activeCategoryData.suggestedIssues.length - 1
                                      ? 'var(--border)'
                                      : 'var(--ink-soft)',
                                }}
                                onClick={() =>
                                  moveSuggestedIssue(activeCategoryIdx, issueIdx, 'down')
                                }
                              ></i>
                            </div>
                            <label className="switch" style={{ margin: 0 }}>
                              <input
                                ...
                                onChange={() => toggleSuggestedIssue(activeCategoryIdx, issueIdx)}
                              />
            ...
            <div className="card">
              ...
              >
                <h3 style={{ color: 'var(--ink)', margin: 0 }} className="fs-6">
              ...
              {settings.slaRules && settings.slaRules.length > 0 ? (
                settings.slaRules.map((rule, idx) => (
                  <div className="settings-row" key={idx}>
                    <div>
                      <span className={`badge ${rule.priority.toLowerCase()}`}>
                        {rule.priority}
                      </span>
                      <div
                        style={{ color: 'var(--ink-faint)', marginTop: '4px' }}
                        className="small"
                      >
                        Resolve within
                      </div>
              ...
              <h3 style={{ marginBottom: '16px', color: 'var(--ink)' }} className="small">
                Working Hours
              </h3>
            ...
            <div className="card">
              ...
              <div className="form-group mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange('workflow', 'autoCloseDays', Number(e.target.value))
                  }
                />
                ...
                <table className="table table-borderless table-hover">
                  ...
                  <tbody>
                    {[
                      ...
                      const rule = (settings.notifications?.events || []).find(
                        (r) => r.event === evt,
              ...
              <div className="form-group mb-3">
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('assignmentRules', 'autoAssign', e.target.checked)
                    }
                    style={{ width: '40px', height: '20px', cursor: 'pointer', margin: 0 }}
                  />
                  <label
                    className="fw-medium form-check-label"
                    htmlFor="autoAssign"
                    style={{ margin: 0 }}
                  >
              ...
              >
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    role="switch"
                    checked={settings.residentFeedback?.enabled || false}
                    onChange={(e) => handleChange('residentFeedback', 'enabled', e.target.checked)}
                    style={{ width: '40px', height: '20px', margin: 0 }}
                  />
                  <label style={{ margin: 0 }} className="fw-medium">
                    Enable Resident Feedback
                  </label>
                </div>
                <div
                  className="form-check form-switch"
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    role="switch"
                    checked={settings.residentFeedback?.allowAnonymous || false}
                    onChange={(e) =>
                      handleChange('residentFeedback', 'allowAnonymous', e.target.checked)
                    }
                    style={{ width: '40px', height: '20px', margin: 0 }}
                  />
                  <label style={{ margin: 0 }} className="fw-medium">
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    role="switch"
                    checked={settings.residentFeedback?.mandatoryBeforeClosing || false}
                    onChange={(e) =>
                      handleChange('residentFeedback', 'mandatoryBeforeClosing', e.target.checked)
                    }
                    style={{ width: '40px', height: '20px', margin: 0 }}
                  />
                  <label style={{ margin: 0 }} className="fw-medium">
              ...
              >
                {(settings.feedbackQuestions || []).map((fq, idx) => (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                      <span
                        style={{ color: fq.isRequired ? 'var(--danger)' : 'var(--ink-faint)' }}
                        className="small"
                      >
              ...
              <div className="form-group mb-3">
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    role="switch"
                    checked={settings.commentSettings?.allowComments ?? true}
                    onChange={(e) =>
                      handleChange('commentSettings', 'allowComments', e.target.checked)
                    }
                    style={{ width: '40px', height: '20px', margin: 0 }}
                  />
                  <label style={{ margin: 0 }} className="fw-medium">
              ...
              <div className="form-group mb-3">
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    role="switch"
                    checked={settings.commentSettings?.mandatoryForLowRatings ?? true}
                    onChange={(e) =>
                      handleChange('commentSettings', 'mandatoryForLowRatings', e.target.checked)
                    }
                    style={{ width: '40px', height: '20px', margin: 0 }}
                  />
                  <label style={{ margin: 0 }} className="fw-medium">
                    Mandatory for Low Ratings
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              >
                {['resident', 'technician', 'facilityManager', 'admin', 'superAdmin'].map(
                  (role) => (
                    <div
                      key={role}
                      className="form-check form-switch"
                    ...
                    >
                      <input
                        ...
                        onChange={(e) => handleChange('feedbackVisibility', role, e.target.checked)}
                        style={{ width: '40px', height: '20px', margin: 0 }}
                      />
                      <label
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => handleChange('feedbackAnalytics', metric, e.target.checked)}
                      style={{ width: '40px', height: '20px', margin: 0 }}
                    />
                    <label style={{ margin: 0, textTransform: 'capitalize' }} className="fw-medium">
            ...
            <div className="card">
              ...
              <div className="form-group mb-3">
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('general', 'duplicateDetection', e.target.checked)
                    }
                    style={{ width: '40px', height: '20px', margin: 0 }}
                  />
                  <label style={{ margin: 0 }} className="fw-medium">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange('general', 'duplicateTimeWindowHours', Number(e.target.value))
                  }
                />
              </div>
              <div className="form-group mb-3">
