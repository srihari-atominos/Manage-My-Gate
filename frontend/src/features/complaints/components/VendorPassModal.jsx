    ...
    >
      ...
      >
        <div style={{ padding: '16px 24px', borderBottom: '1px solid #e5e7eb', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <button 
            onClick={handleClose}
            style={{ background: 'transparent', border: 'none', fontSize: '20px', cursor: 'pointer', padding: 0 }}
          >
            &times;
          </button>
        </div>
        ...
        <div style={{ padding: '24px', textAlign: 'center' }}>
          ...
          <div style={{ background: '#fff', padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px', display: 'inline-block', marginBottom: '16px' }}>
            ...
            <div style={{ marginTop: '12px', color: '#1f2937' }}>
              ...
              <div style={{ color: '#6b7280', fontSize: '14px', marginTop: '4px' }}>{generatedVendorPass.visitorDetails?.name}</div>
        ...
        <div style={{ padding: '16px 24px', backgroundColor: '#f9fafb', borderTop: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <button
            onClick={() => {
              if (navigator.share) {
            ...
            style={{ width: '100%', padding: '10px', background: '#10b981', color: 'white', border: 'none', borderRadius: '6px', fontWeight: '500', fontSize: '14px', cursor: 'pointer' }}
          >
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              style={{ flex: 1, textAlign: 'center', padding: '10px', background: '#25D366', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: '500', fontSize: '14px' }}
            >
              <i className="fa-brands fa-whatsapp me-2"></i> WhatsApp
            </a>
            <a 
              href={smsUrl}
              style={{ flex: 1, textAlign: 'center', padding: '10px', background: '#e5e7eb', color: '#374151', borderRadius: '6px', textDecoration: 'none', fontWeight: '500', fontSize: '14px', border: '1px solid #d1d5db' }}
            >
          ...
          <button 
            onClick={handleClose}
            style={{ width: '100%', padding: '10px', background: '#6b7280', color: 'white', border: 'none', borderRadius: '6px', fontWeight: '500', fontSize: '14px', cursor: 'pointer' }}
          >
            Done
          </button>
        </div>
