...
export const FeatureConfigWizard = () => {
  ...
  const features = [
    ...
    {
      id: 'notices',
      titleKey: 'workspace.wizard.notices.title',
    ...
    {
      id: 'visitor',
      titleKey: 'workspace.wizard.visitor.title',
      descKey: 'workspace.wizard.visitor.desc',
      icon: cilAddressBook,
    },
    {
      id: 'billing',
      titleKey: 'workspace.wizard.billing.title',
