          ...
          <div key={villa.id} className="villa-directory-card">
            <div>
              <div className="villa-directory-badge-wrap">
                ...
                <span
                  className={
                    villa.status === 'Occupied' ? 'villa-status-occupied' : 'villa-status-vacant'
                  }
                >
                  {villa.status}
                </span>
              </div>
              <div className="table-cell-muted mt-1">Resident: {villa.resident}</div>
      ...
      {activeCall && (
        <div className="intercom-modal-backdrop">
          <div className="intercom-modal-card">
            <div className="intercom-modal-title">Gate Intercom Outgoing Call</div>
