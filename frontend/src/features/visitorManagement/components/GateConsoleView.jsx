              ...
              {scanResult === 'success' && matchedPass ? (
                <div>
                  <i
                    ...
                    style={{ fontSize: '42px', color: '#059669', marginBottom: '12px' }}
                  ></i>
                  <h4 style={{ margin: 0, color: '#065F46', fontSize: '18px', fontWeight: '800' }}>
                    ACCESS GRANTED
                  </h4>
                  <p style={{ margin: '8px 0 16px', fontSize: '14px', color: '#047857' }}>
                    Pass verified for <strong>{matchedPass.visitorName}</strong>. Valid until{' '}
                    {matchedPass.validity}.
                  </p>
                  <button
                ...
                <div>
                  <i
                    ...
                    style={{ fontSize: '42px', color: '#DC2626', marginBottom: '12px' }}
                  ></i>
                  <h4 style={{ margin: 0, color: '#991B1B', fontSize: '18px', fontWeight: '800' }}>
                    ACCESS DENIED
                  </h4>
                  <p style={{ margin: '8px 0 0', fontSize: '14px', color: '#B91C1C' }}>
                    {matchedPass
                      ? `Pass state is "${matchedPass.status}".`
                      : 'Invalid credentials. Pass code not registered.'}
                  </p>
                </div>
              )}
            </div>
              ...
              {searchResults.length === 0 ? (
                ...
                searchResults.map((pass) => (
                  ...
                  >
                    <div>
                      <div
                        style={{ fontWeight: '700', fontSize: '14px', color: 'var(--text-main)' }}
                      >
                        {pass.visitorName}
                      </div>
                      <div
                        style={{ fontSize: '11px', color: 'var(--text-light)', marginTop: '2px' }}
                      >
                    ...
                    >
                      {['ACTIVE', 'Active', 'PENDING', 'Pending'].includes(pass.status)
                        ? 'Check-In'
                        : 'Expired'}
                    </button>
                  </div>
        ...
        <div className="card" style={{ borderTop: '4px solid var(--success)', height: '100%' }}>
          ...
          <form onSubmit={handleWalkInSubmit}>
            ...
            {walkinStatus === 'approved' && (
              ...
              >
                <i className="fa-solid fa-circle-check" style={{ marginRight: '8px' }}></i> APPROVED
                BY RESIDENT
              </div>
            )}
          </form>
