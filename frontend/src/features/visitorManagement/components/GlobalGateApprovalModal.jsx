...
export const GlobalGateApprovalModal = () => {
  ...
  const visitorName =
    activeGateRequest.visitorName || activeGateRequest.snapshot?.visitorName || 'Walk-in Visitor'
  ...
  const gateNumber =
    activeGateRequest.gateNumber || activeGateRequest.snapshot?.gateNumber || 'Gate 1'
  const photoUrl =
    activeGateRequest.photoUrl ||
    activeGateRequest.snapshot?.photoUrl ||
    'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&auto=format&fit=crop&q=60'
  const idProofType =
    activeGateRequest.idProofType || activeGateRequest.snapshot?.idProofType || 'None'
  const idProofNumber =
    activeGateRequest.idProofNumber || activeGateRequest.snapshot?.idProofNumber || ''

  return (
    <CModal
      visible={!!activeGateRequest}
      onClose={handleClose}
      alignment="center"
      backdrop="static"
    >
      <CModalHeader closeButton>
        <CModalTitle className="fw-bold text-primary">🔔 Incoming Gate Request</CModalTitle>
      </CModalHeader>
        ...
        <div className="d-flex align-items-center gap-3 mb-4">
          <img
            ...
            style={{
              ...
              borderRadius: '50%',
              objectFit: 'cover',
              border: '3px solid var(--primary, #0084FF)',
            }}
          />
          <div>
