...
export const useVilla = () => {
  ...
  const orgId =
    activeWorkspace?.activeOrganizationId ||
    activeWorkspace?.activeOrgId ||
  ...
  const bulkUploadVillas = useCallback(
    async (villas) => {
  ...
  const batchGenerateVillas = useCallback(
    async (batchData) => {
  ...
  const assignExistingUser = useCallback(
    async (villaId, userId, residencyType) => {
  ...
  const updateResidencyType = useCallback(
    async (villaId, userId, residencyType) => {
