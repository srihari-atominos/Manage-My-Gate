...
export const fetchVillaBlocksAsync = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to fetch blocks',
      )
    }
  },
)
...
export const fetchVillaByIdAsync = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to fetch unit details',
      )
    }
  },
)
...
export const assignPrimaryResidentAsync = createAsyncThunk(
  ...
  async ({ id, residentId }, { dispatch, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to assign primary resident',
      )
    }
  },
)
...
export const batchGenerateVillasAsync = createAsyncThunk(
  ...
  async (batchData, { dispatch, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to batch generate units',
      )
    }
  },
)
...
export const fetchVillaStatsAsync = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to fetch unit statistics',
      )
    }
  },
)
...
export const bulkUploadVillasAsync = createAsyncThunk(
  ...
  async (villas, { dispatch, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to bulk upload units',
      )
    }
  },
)
...
export const assignExistingUserThunk = createAsyncThunk(
  ...
  async ({ villaId, userId, residencyType }, { dispatch, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to assign resident',
      )
    }
  },
)
...
export const updateResidencyTypeThunk = createAsyncThunk(
  ...
  async ({ villaId, userId, residencyType }, { dispatch, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to update residency type',
      )
    }
  },
)
...
export const removeResidentThunk = createAsyncThunk(
  ...
  async ({ villaId, userId }, { dispatch, rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || error.message || 'Failed to remove resident',
      )
    }
  },
)
