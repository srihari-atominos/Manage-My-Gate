...
const initialState = {
  ...
  connections: [
    ...
    },
    {
      ...
      _id: '5',
      provider: 'sendgrid',
      accountLabel: 'SendGrid Transactional',
      status: 'connected',
    ...
    },
    {
      ...
      _id: '6',
      provider: 'stripe',
      accountLabel: 'Stripe Live Payments',
      status: 'connected',
      createdAt: '2026-06-17T10:25:00.000Z',
    },
  ],
  bankDetails: {
    accountHolderName: '',
