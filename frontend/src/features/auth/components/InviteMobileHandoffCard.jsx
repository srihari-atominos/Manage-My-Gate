...
export const InviteMobileHandoffCard = ({ handoffData, orgName }) => {
  ...
  const { deepLink, playStoreUrl, appStoreUrl } = handoffData || {}
          ...
          <div className="d-flex flex-wrap gap-2 pt-1">
            {playStoreUrl && (
              <a
                ...
                className="btn btn-outline-secondary btn-sm fw-medium d-inline-flex align-items-center"
              >
                {t('auth.handoff.googlePlay', 'Google Play')}
              </a>
            )}
            {appStoreUrl && (
              <a
                ...
                className="btn btn-outline-secondary btn-sm fw-medium d-inline-flex align-items-center"
              >
                {t('auth.handoff.appStore', 'App Store')}
              </a>
            )}
          </div>
        </div>
