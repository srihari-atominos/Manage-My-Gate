...
const RoleBuilderList = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        render: (val) => (
          <Badge
            variant={val ? 'lightInfo' : 'lightPrimary'}
      ...
      },
      {
        ...
        render: (val) => {
          ...
          return (
            <Badge
              variant={count > 0 ? 'lightSuccess' : 'outlineSecondary'}
  ...
  return (
    <div className="mx-auto max-w-6xl p-4 sm:p-6 role-builder-container">
      <PageHeader
      ...
      {error && (
        <Alert variant="destructive" className="mb-4" id="role-list-error-alert">
