            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderBottom: index !== displayedList.length - 1 ? '1px solid var(--border-light)' : 'none',
                  cursor: 'pointer',
                }}
              >
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: bg, color: color, display: 'flex', alignItems: 'center', justify: 'center' }} className="fs-4 flex-shrink-0">
                  <i className={icon}></i>
                </div>
                <div style={{ flex: 1 }}>
