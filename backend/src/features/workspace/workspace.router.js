...
router.get('/:workspaceId/settings', allowedManagers, validate(workspaceIdParamRules), workspaceController.getSettings);
router.put('/:workspaceId/settings', allowedManagers, validate(workspaceIdParamRules), workspaceController.updateSettings);
router.get('/:workspaceId/activity', allowedManagers, validate(workspaceIdParamRules), workspaceController.getActivityLogs);
