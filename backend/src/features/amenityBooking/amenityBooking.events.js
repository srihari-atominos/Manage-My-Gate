...
export const AMENITY_BOOKING_CONFIRMED = 'AMENITY_BOOKING_CONFIRMED';
export const AMENITY_BOOKING_DENIED = 'AMENITY_BOOKING_DENIED';
export const QR_EXPIRED = 'QR_EXPIRED';
