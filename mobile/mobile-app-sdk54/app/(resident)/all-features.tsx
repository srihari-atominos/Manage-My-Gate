  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top', 'bottom']}>
      ...
      <View className="bg-card border-b border-border px-4 py-3.5 flex-row items-center justify-between shadow-xs">
        ...
        <Text className="text-base font-extrabold text-foreground font-sans">All Features</Text>

        <TouchableOpacity
          onPress={() => setCustomiseOpen(true)}
          activeOpacity={0.8}
          className="flex-row items-center gap-1 bg-secondary border border-border/80 px-3 py-1.5 rounded-full shadow-xs"
        >
                  ...
                  <View className="flex-row items-center justify-between pt-1">
                    ...
                    {hasMore && (
                      <TouchableOpacity
                        ...
                        className="flex-row items-center gap-1 bg-[#245FA8]/10 px-2.5 py-1 rounded-full border border-[#245FA8]/30 shadow-xs"
                      >
                        <Text className="text-xs font-bold text-[#245FA8] font-sans">
