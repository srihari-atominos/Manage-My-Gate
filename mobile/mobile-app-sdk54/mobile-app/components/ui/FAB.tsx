...
const fabVariants = cva(
  cn(
    'absolute bottom-20 right-4 z-50 flex-row items-center justify-center shadow-md border border-border/40',
    Platform.select({
      web: 'cursor-pointer select-none transition-shadow hover:shadow-lg',
    })
  ),
  {
    variants: {
      ...
      hasLabel: {
        true: 'rounded-full px-5 py-3 gap-2 min-h-[52px]',
        false: 'w-[52px] h-[52px] rounded-full',
      },
    },
    defaultVariants: {
      variant: 'primary',
