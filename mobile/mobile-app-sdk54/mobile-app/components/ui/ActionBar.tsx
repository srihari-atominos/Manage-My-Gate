    ...
    return (
      ...
      >
        ...
        {destructiveAction && (
          ...
          >
            <Text className="text-destructive font-semibold font-sans text-[15px]">
        ...
        {secondaryAction && (
          <Button
            ...
            className="flex-1"
          >
            <Text className="font-semibold font-sans text-[15px]">
        ...
        {primaryAction && (
          ...
          >
            ...
            <Text className="text-primary-foreground font-bold font-sans text-[15px]">
              {primaryAction.label}
            </Text>
          </Button>
        )}
