...
export const ALL_AVAILABLE_FEATURES: AppFeatureItem[] = [
  ...
  { id: 'admin_users', name: 'User Management', subtitle: 'Residents & Staff', iconName: 'Users', colorBg: 'bg-[#E0EEFF]', colorIcon: '#245FA8', iconShapeClass: 'rounded-[10px]', permission: 'users:read', categoryKey: 'administration_security', categoryName: 'Administration & Security' },
  { id: 'admin_villas', name: 'Unit Management', subtitle: 'Blocks & Villas', iconName: 'Home', colorBg: 'bg-[#E6F8F0]', colorIcon: '#16A34A', iconShapeClass: 'rounded-[10px]', permission: 'villas:read', categoryKey: 'administration_security', categoryName: 'Administration & Security' },
  { id: 'admin_role_builder', name: 'Role Builder', subtitle: 'RBAC Matrices', iconName: 'ShieldCheck', colorBg: 'bg-[#FCEBF4]', colorIcon: '#A51B73', iconShapeClass: 'rounded-[10px]', permission: 'roles:read', categoryKey: 'administration_security', categoryName: 'Administration & Security' },
  { id: 'admin_workspace_settings', name: 'Workspace Settings', subtitle: 'Tenant Rules', iconName: 'Settings', colorBg: 'bg-[#EEF2F6]', colorIcon: '#475569', iconShapeClass: 'rounded-[10px]', permission: 'workspaces:read', categoryKey: 'administration_security', categoryName: 'Administration & Security' },
  { id: 'admin_integrations', name: 'Integration Hub', subtitle: 'API & Webhooks', iconName: 'Layers', colorBg: 'bg-[#FEF6E8]', colorIcon: '#D97706', iconShapeClass: 'rounded-[10px]', permission: 'integrations:read', categoryKey: 'administration_security', categoryName: 'Administration & Security' },
  { id: 'admin_organizations', name: 'Org Manager', subtitle: 'Platform Tenancy', iconName: 'Building', colorBg: 'bg-[#F0EBFA]', colorIcon: '#51418F', iconShapeClass: 'rounded-[10px]', permission: 'platform:super_admin', categoryKey: 'administration_security', categoryName: 'Administration & Security' },
  { id: 'admin_audit_logs', name: 'Audit Logs', subtitle: 'Security Activity', iconName: 'History', colorBg: 'bg-[#E0EEFF]', colorIcon: '#245FA8', iconShapeClass: 'rounded-[10px]', permission: 'platform:super_admin', categoryKey: 'administration_security', categoryName: 'Administration & Security' },
];
