    ...
    getItem: function (key) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    err_1 = _a.sent();
                    console.warn("SecureStore getItem failed for key: ".concat(key, ", falling back to memory."), err_1);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/, memoryCache[key] || null];
            }
        });
    }); },
    setItem: function (key, value) { return __awaiter(void 0, void 0, void 0, function () {
        var isAvailable, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 4:
                    err_2 = _a.sent();
                    console.warn("SecureStore setItem failed for key: ".concat(key, ", falling back to memory."), err_2);
                    return [3 /*break*/, 5];
                case 5:
    ...
    removeItem: function (key) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    err_3 = _a.sent();
                    console.warn("SecureStore deleteItem failed for key: ".concat(key, ", falling back to memory."), err_3);
                    return [3 /*break*/, 5];
                case 5:
