...
const PERMISSION_SYNONYMS: Record<string, string[]> = {
  ...
  'notices:manage_notices': ['notices:manage_notices', 'notices.manage_notices', 'manage_notices', 'manage_engagement', 'notices:create', 'notices:update', 'notices.create', 'notices.update', 'notices'],
