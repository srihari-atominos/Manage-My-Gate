...
const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    invalid_org_type: 'Invalid organization type. Must be Residential, Commercial, or Mixed',
    residential: 'Residential',
    commercial: 'Commercial',
    mixed: 'Mixed',
    checking_availability: 'Checking availability...',
    name_available: 'Name is available',
    name_unavailable: 'Organization name is already taken',
    create: 'Create',
    creating: 'Creating...',
    required_field: 'This field is required',
    name_min_length: 'Organization name must be at least 3 characters',
    name_max_length: 'Organization name cannot exceed 100 characters',
  ...
  ar: {
    ...
    org_type_required: 'نوع المنظمة مطلوب',
    invalid_org_type: 'نوع المنظمة غير صالح. يجب أن يكون سكني أو تجاري أو مختلط',
    residential: 'سكني',
    commercial: 'تجاري',
    mixed: 'مختلط',
    checking_availability: 'جار التحقق من التوفر...',
    name_available: 'الاسم متاح',
    name_unavailable: 'اسم المنظمة مأخوذ بالفعل',
    create: 'إنشاء',
    creating: 'جار الإنشاء...',
    required_field: 'هذا الحقل مطلوب',
    name_min_length: 'يجب ألا يقل اسم المنظمة عن 3 أحرف',
    name_max_length: 'يجب ألا يزيد اسم المنظمة عن 100 حرف',
    invalid_name: 'اسم المنظمة غير صالح',
    org_already_exists: 'توجد منظمة بهذا الاسم بالفعل.',
