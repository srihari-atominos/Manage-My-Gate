...
export function AllNotesScreen() {
  ...
  return (
    <ScreenShell
      title="All Community Notes"
      subtitle="Discover 24-hour neighbor notes & publish your status"
      iconName="Sparkles"
      showBackButton={true}
    >
      <View className="flex-1 bg-background px-4 pt-3 pb-6 gap-3.5">
        ...
        <SegmentedControl
          segments={[
            ...
            { key: 'compose', label: myActiveNote ? 'My Active Note' : '+ Publish Note' },
          ]}
          ...
          <ScrollView className="flex-1" showsVerticalScrollIndicator={false} contentContainerClassName="gap-4 pb-12">
            ...
            {myActiveNote ? (
              <View className="bg-primary/10 border border-primary/20 rounded-2xl p-4 gap-2">
                <View className="flex-row items-center justify-between">
                  <Text className="text-xs font-bold text-primary uppercase">Active Community Note</Text>
              ...
              <View className="bg-muted/40 border border-border p-4 rounded-2xl gap-1">
                <Text className="text-xs font-bold text-foreground">Post a 24-Hour Community Note</Text>
                <Text className="text-xs text-muted-foreground leading-relaxed">
                  Let neighbors know what activities, hobbies, or quick events you are hosting or looking for today!
                </Text>
              </View>
            )}
            ...
            <View className="gap-2">
              <View className="flex-row items-center gap-1.5">
                ...
                <Text className="text-xs font-bold text-foreground">
                  {myActiveNote ? 'Replace Note with Idea' : 'Quick Idea Presets'}
                </Text>
              </View>
            ...
            <View className="gap-1.5">
              <Input
                ...
                placeholder="Type your 24-hour note (max 80 chars)..."
                multiline
                numberOfLines={3}
            ...
            {activeNotes.length > 0 ? (
              ...
              <View className="items-center justify-center py-16 px-4 gap-2">
                ...
                <Text className="text-xs text-muted-foreground text-center max-w-[260px]">
                  Be the first to share what's happening in your community today.
                </Text>
                <Button
                  variant="default"
                  size="default"
