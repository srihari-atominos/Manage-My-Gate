...
describe('Navigation Forensic Audit & Feature Cutover', () => {
  ...
  describe('4. Migrated Features Route Availability & Resolution', () => {
    const requiredFeatureRoutes = [
      ...
      { id: 'notices_active_board', expected: '/(resident)/notices/active-board' },
      { id: 'notices_dashboard', expected: '/(resident)/notices/dashboard' },
      { id: 'notices_manage_notices', expected: '/(resident)/notices/manage' },
      { id: 'notices_polls', expected: '/(resident)/notices/polls' },
