    ...
    >
      ...
      <View className="flex-row items-center justify-end gap-2 pt-2 mt-1">
        <Button
          ...
          size="sm"
          onPress={() => onEdit(item)}
          className="flex-row items-center gap-1 h-7 px-2.5 rounded-lg border-primary/30 bg-primary/10"
        ...
        <Button
          ...
          className="flex-row items-center gap-1 h-7 px-2.5 rounded-lg bg-card border-border"
          accessibilityLabel={isActive ? `Deactivate ${item.name}` : `Activate ${item.name}`}
        >
          <Power size={11} className={isActive ? 'text-amber-500' : 'text-status-success'} />
        ...
        <Button
          ...
          className="flex-row items-center gap-1 h-7 px-2.5 rounded-lg"
          accessibilityLabel={`Delete ${item.name}`}
        >
          <Trash2 size={11} className="text-destructive-foreground" />
