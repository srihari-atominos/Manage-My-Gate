...
export interface MaintenanceStepItem {
  key: string;
  title: string;
  subtitle?: string;
}

export interface MaintenanceStepIndicatorProps {
  steps: MaintenanceStepItem[];
  currentStepIndex: number;
}

export const MaintenanceStepIndicator: React.FC<MaintenanceStepIndicatorProps> = ({
  steps,
  currentStepIndex,
}) => {
...
export default MaintenanceStepIndicator;
