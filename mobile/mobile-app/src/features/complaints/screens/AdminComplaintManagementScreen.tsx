  ...
  return (
    ...
    >
      <View className="flex-1 bg-background">
        ...
        >
          {/* SEARCH, ADVANCED FILTER & VIEW FEEDBACK BUTTON BAR */}
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row gap-2 py-1">
              {filterTabs.map((tab) => {
                ...
                return (
                  ...
                  >
                    <Text style={{ color: isActive ? '#ffffff' : '#334155', fontWeight: '600', fontSize: 12 }}>
                      {tab.label}
                    </Text>
                    ...
                    {tab.count !== undefined && tab.count > 0 ? (
                      ...
                      >
                        <Text style={{ color: isActive ? '#ffffff' : '#64748b', fontWeight: 'bold', fontSize: 10 }}>
                          {tab.count}
                        </Text>
                      </View>
                    ) : null}
