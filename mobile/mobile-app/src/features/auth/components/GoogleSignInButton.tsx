...
export function GoogleSignInButton() {
  ...
  return (
    <Button
      variant="outline"
      className="h-12 w-full rounded flex-row items-center justify-center bg-white border border-border"
      onPress={() => promptAsync()}
    ...
    >
      ...
      <Text className="text-slate-700 font-semibold text-sm">Google</Text>
    </Button>
  );
}
