...
export function RazorpayCheckoutModal({
  ...
  const htmlContent = useMemo(() => {
    ...
    const name = 'ManageMyGate Digital Wallet';
    const description = options.description || `Wallet Top-Up (₹${options.amount})`;
      ...
      <View className="flex-1 bg-background">
        ...
        <View className="flex-row items-center justify-between px-4 py-3 border-b border-border bg-card pt-12">
          <View className="flex-row items-center">
            ...
            <View>
              <Text className="font-bold text-sm text-foreground">Razorpay Secure Top-Up</Text>
            ...
            <View className="flex-1 items-center justify-center p-6">
              ...
              <View className="w-full bg-card border border-border rounded-2xl p-4 mb-6 gap-2.5">
                ...
                <View className="flex-row justify-between items-center">
                  ...
                  <Text className="text-base font-extrabold text-status-success">₹{options.amount.toLocaleString('en-IN')}</Text>
                </View>
                <View className="flex-row justify-between items-center">
              ...
              <View className="w-full bg-amber-500/10 border border-amber-500/20 rounded-xl p-3.5 mb-6 flex-row items-center">
                ...
                <Text className="text-xs text-amber-900 dark:text-amber-200 flex-1">
                  Using test environment key. Tap below to simulate successful payment capture and credit to wallet.
                </Text>
              </View>
