...
export const ALL_AVAILABLE_FEATURES: AppFeatureItem[] = [
  ...
  { id: 'amenities_settings', name: 'Pricing / Settings', subtitle: 'Rate Cards & Rules', iconName: 'SlidersHorizontal', colorBg: 'bg-indigo-50 dark:bg-indigo-950/40', colorIcon: '#6366F1', iconShapeClass: 'rounded-[18px]', route: '/(resident)/amenities/settings', permission: 'amenities:settings', categoryKey: 'amenities_facilities', categoryName: 'Amenities & Booking' },
  ...
  { id: 'complaints_track_requests', name: 'Track Tickets', subtitle: 'Live Status', iconName: 'Route', colorBg: 'bg-blue-50 dark:bg-blue-950/40', colorIcon: '#2563EB', iconShapeClass: 'rounded-[18px]', route: '/(resident)/complaints/my-tickets', permission: 'complaints:track_requests', categoryKey: 'complaints_helpdesk', categoryName: 'Complaints & Maintenance' },
  ...
  { id: 'notices_active_board', name: 'Notice Board', subtitle: 'Circulars', iconName: 'Megaphone', colorBg: 'bg-pink-50 dark:bg-pink-950/40', colorIcon: '#DB2777', iconShapeClass: 'rounded-[18px]', route: '/(resident)/notices/active-board', permission: 'notices:active_board', categoryKey: 'notice_board_polls', categoryName: 'Notice Board' },
...
export const isFeatureAllowedForUser = (
  ...
  if (user?.isPlatform === true || userPermissions.includes('platform:super_admin') || userPermissions.includes('*')) {
    return true;
  }
