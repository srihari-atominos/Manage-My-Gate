    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View className="flex-1 bg-black/60 justify-end">
        <View className="bg-card border-t border-border rounded-t-3xl max-h-[85%] min-h-[50%] shadow-2xl overflow-hidden flex-col">
            ...
            <View className="flex-row items-center gap-2">
              {unreadCount > 0 && (
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                  className="flex-row items-center gap-1 bg-muted px-2.5 py-1.5 rounded-full border border-border"
                >
                  <CheckCheck size={13} color="#03A9F4" />
          ...
          <View className="flex-row px-5 py-2.5 border-b border-border bg-muted/20 gap-2">
            <TouchableOpacity
                ...
                {filteredItems.map((notification) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <View className="p-2.5 rounded-xl bg-card border border-border mt-0.5">
                      ...
                      <View className="flex-1 pr-4">
                        ...
                        {notification.actionUrl && (
                          <View className="flex-row items-center gap-0.5 mt-2">
                            ...
                            <ChevronRight size={10} color="#03A9F4" />
                          </View>
                        )}
                      </View>
