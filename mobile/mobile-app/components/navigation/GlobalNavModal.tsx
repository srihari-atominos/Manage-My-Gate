        ...
        <View className="bg-card border-t border-border rounded-t-3xl h-[85%] p-4 shadow-2xl gap-3">
          ...
          <View className="flex-row items-center justify-between pb-3 border-b border-border">
            <View className="flex-row items-center gap-2">
              <View className="bg-primary/10 p-2 rounded-xl border border-primary/20">
            ...
            <TouchableOpacity onPress={onClose} activeOpacity={0.7} className="p-2 rounded-full bg-muted">
                  ...
                  <View className="flex-row flex-wrap justify-between gap-y-2.5">
                    {category.items.map((item) => (
                      <Pressable
                        ...
                        className="w-[48.5%] bg-card p-3 rounded-2xl border border-border/80 flex-row items-center justify-between active:opacity-75 shadow-xs relative"
                      >
                        {item.badge ? (
                        ...
                        <View className="flex-row items-center flex-1 me-1">
                          <View className="w-8 h-8 rounded-xl bg-muted items-center justify-center me-2.5 shrink-0">
